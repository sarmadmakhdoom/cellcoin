...
#if defined(NDEBUG)
# error "Sarmadcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Sarmadcoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s SMC additional fees, %d delta bytes\n",
