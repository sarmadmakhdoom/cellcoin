...
const char * const BITCOIN_CONF_FILENAME = "cellcoin.conf";
const char * const BITCOIN_PID_FILENAME = "cellcoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Cellcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Cellcoin";
#else
    // Unix
    return pathRet / ".cellcoin";
#endif
#endif
}
